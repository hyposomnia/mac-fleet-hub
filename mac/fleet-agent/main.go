...
func runServer() {
	...
	mux.HandleFunc("/api/file/mkdir", handleFileMkdir)
	mux.HandleFunc("/api/file/upload", handleFileUpload)
	mux.HandleFunc("/api/file/rename", handleFileRename)
	mux.HandleFunc("/api/file/delete", handleFileDelete)
	...
	mux.HandleFunc("/api/chat/subagents", handleChatSubagents)
