...
const CACHE = 'fleet-shell-v20';
const SHELL = ['/', '/index.html', '/style.css?v=20', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=20', '/chat_model.js?v=20', '/app.js?v=20', '/manifest.webmanifest'];
