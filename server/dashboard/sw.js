...
const CACHE = 'fleet-shell-v37';
const SHELL = ['/', '/index.html', '/style.css?v=37', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=37', '/chat_model.js?v=37', '/app.js?v=37', '/manifest.webmanifest'];
