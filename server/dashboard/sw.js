...
const CACHE = 'fleet-shell-v17';
const SHELL = ['/', '/index.html', '/style.css?v=17', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=17', '/chat_model.js?v=17', '/app.js?v=17', '/manifest.webmanifest'];
