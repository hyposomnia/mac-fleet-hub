...
const CACHE = 'fleet-shell-v10';
const SHELL = ['/', '/index.html', '/style.css?v=10', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=10', '/chat_model.js?v=10', '/app.js?v=10', '/manifest.webmanifest'];
