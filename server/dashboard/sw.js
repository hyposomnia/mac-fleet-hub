...
const CACHE = 'fleet-shell-v38';
const SHELL = ['/', '/index.html', '/style.css?v=38', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=38', '/chat_model.js?v=38', '/app.js?v=38', '/manifest.webmanifest'];
