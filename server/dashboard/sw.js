...
const CACHE = 'fleet-shell-v41';
const SHELL = ['/', '/index.html', '/style.css?v=41', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=41', '/chat_model.js?v=41', '/app.js?v=41', '/manifest.webmanifest'];
