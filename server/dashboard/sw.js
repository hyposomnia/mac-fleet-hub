...
const CACHE = 'fleet-shell-v42';
const SHELL = ['/', '/index.html', '/style.css?v=42', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=42', '/chat_model.js?v=42', '/app.js?v=42', '/manifest.webmanifest'];
