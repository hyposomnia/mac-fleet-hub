...
const CACHE = 'fleet-shell-v40';
const SHELL = ['/', '/index.html', '/style.css?v=40', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=40', '/chat_model.js?v=40', '/app.js?v=40', '/manifest.webmanifest'];
