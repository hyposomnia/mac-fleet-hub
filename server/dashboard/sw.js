...
const CACHE = 'fleet-shell-v23';
const SHELL = ['/', '/index.html', '/style.css?v=23', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=23', '/chat_model.js?v=23', '/app.js?v=23', '/manifest.webmanifest'];
