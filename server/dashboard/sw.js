...
const CACHE = 'fleet-shell-v12';
const SHELL = ['/', '/index.html', '/style.css?v=12', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=12', '/chat_model.js?v=12', '/app.js?v=12', '/manifest.webmanifest'];
