...
const CACHE = 'fleet-shell-v18';
const SHELL = ['/', '/index.html', '/style.css?v=18', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=18', '/chat_model.js?v=18', '/app.js?v=18', '/manifest.webmanifest'];
