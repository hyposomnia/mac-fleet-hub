...
const CACHE = 'fleet-shell-v25';
const SHELL = ['/', '/index.html', '/style.css?v=25', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=25', '/chat_model.js?v=25', '/app.js?v=25', '/manifest.webmanifest'];
