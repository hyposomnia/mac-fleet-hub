...
const CACHE = 'fleet-shell-v24';
const SHELL = ['/', '/index.html', '/style.css?v=24', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=24', '/chat_model.js?v=24', '/app.js?v=24', '/manifest.webmanifest'];
