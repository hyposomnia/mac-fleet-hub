...
const CACHE = 'fleet-shell-v33';
const SHELL = ['/', '/index.html', '/style.css?v=33', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=33', '/chat_model.js?v=33', '/app.js?v=33', '/manifest.webmanifest'];
