...
const CACHE = 'fleet-shell-v27';
const SHELL = ['/', '/index.html', '/style.css?v=27', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=27', '/chat_model.js?v=27', '/app.js?v=27', '/manifest.webmanifest'];
