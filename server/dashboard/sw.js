...
const CACHE = 'fleet-shell-v43';
const SHELL = ['/', '/index.html', '/style.css?v=43', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=43', '/chat_model.js?v=43', '/app.js?v=43', '/manifest.webmanifest'];
