...
const CACHE = 'fleet-shell-v28';
const SHELL = ['/', '/index.html', '/style.css?v=28', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=28', '/chat_model.js?v=28', '/app.js?v=28', '/manifest.webmanifest'];
