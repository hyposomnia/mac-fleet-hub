...
const CACHE = 'fleet-shell-v11';
const SHELL = ['/', '/index.html', '/style.css?v=11', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=11', '/chat_model.js?v=11', '/app.js?v=11', '/manifest.webmanifest'];
