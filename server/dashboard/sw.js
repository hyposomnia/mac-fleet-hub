...
const CACHE = 'fleet-shell-v30';
const SHELL = ['/', '/index.html', '/style.css?v=30', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=30', '/chat_model.js?v=30', '/app.js?v=30', '/manifest.webmanifest'];
