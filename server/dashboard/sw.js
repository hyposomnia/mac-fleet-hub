...
const SHELL = ['/', '/index.html', '/style.css?v=9', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=9', '/chat_model.js?v=9', '/app.js?v=9', '/manifest.webmanifest'];
