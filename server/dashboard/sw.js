...
const CACHE = 'fleet-shell-v39';
const SHELL = ['/', '/index.html', '/style.css?v=39', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=39', '/chat_model.js?v=39', '/app.js?v=39', '/manifest.webmanifest'];
