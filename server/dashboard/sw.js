...
const CACHE = 'fleet-shell-v15';
const SHELL = ['/', '/index.html', '/style.css?v=15', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=15', '/chat_model.js?v=15', '/app.js?v=15', '/manifest.webmanifest'];
