...
const CACHE = 'fleet-shell-v36';
const SHELL = ['/', '/index.html', '/style.css?v=36', '/vendor/purify.min.js?v=3.2.6',
  '/vendor/marked.min.js?v=15.0.12', '/markdown.js?v=36', '/chat_model.js?v=36', '/app.js?v=36', '/manifest.webmanifest'];
